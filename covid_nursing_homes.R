...
nurs_home_sel %>%
  ...
  tab_row_group(label = 'Neville Center at Fresh Pond' , 
                str_detect(provider_name , str_to_upper('Neville'))) %>%
  cols_hide(provider_name) %>%
  tab_footnote(footnote = 'Resident COVID cases is the number of laboratory-confirmed 
  ...
  tab_footnote(footnote = 'Staff COVID cases is the number of laboratory-confirmed
